...
**NEURA Office** is the Office layer of that stack: tools that turn model output
into real `.docx`, `.pptx` and `.xlsx` files, and (next) an assistant that lives
inside Microsoft 365 apps with the same backend.
...
and the [hub README](README.md) are the public explanation.
